    ...
    return (
        <div className="px-4 md:px-20 pt-20  duration-200">
            <div ref={ref} className={`w-full md:w-[700px] transition-transform duration-100 ${isVisible ? 'animate-slideIn' : '-translate-x-1'}`}>
                <button className="border rounded-tr-xl px-4 py-1 text-xs font-mono font-semibold bg-[#3b82f6] text-gray-200">APPROACH</button>
                <h2 className="mt-4 mb-8 text-3xl md:text-4xl font-mono text-gray-800">
                    Holistic, compassionate, empowering mental health support.</h2>
            </div>

            <div className="py-20 px-4 md:px-10 bg-[#3b82f6] text-gray-100 text-3xl  md:rounded-tr-[100px] ">
